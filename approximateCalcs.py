...
# print(thetaSpherical_Emax)
thetaSpherical_Emin = np.pi/2 + bragg_E_to_theta(E_min_eV)  # 2.3549429089112266
# print(thetaSpherical_Emin)
thetaSpherical_Ealpha = np.pi/2 + bragg_E_to_theta(E_Lalpha_eV)  # 2.2835354140812525
# print(thetaSpherical_Ealpha)
thetaSpherical_Ebeta = np.pi/2 + bragg_E_to_theta(E_Lbeta_eV)  # 2.26209819686507
# print(thetaSpherical_Ebeta)
